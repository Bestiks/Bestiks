...
1. **Проект 1**: [Арома]([ссылка](https://github.com/Bestiks/Aroma)) — 
...
2. **Проект 2**: [Название проекта]([ссылка](https://github.com/Bestiks/CSGO-Store)) — проект представляет собой веб-сайт интернет-магазина, специализирующегося на продаже игрового оборудования и аксессуаров, предположительно связанных с игрой CS:GO. Вот краткое описание проекта:
3. **Проект 3**: [Название проекта]([ссылка](https://github.com/Bestiks/Living)) — проект представляет собой лендинг-страницу для элитного жилого комплекса "Luxury Living". 
